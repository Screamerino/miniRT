...
/*   Updated: 2022/03/25 19:42:07 by lcoreen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minirt_bonus.h"

static void	init_check_board(t_obj *obj, char *rule, t_data *data, int line)
{
	obj->checker = !ft_strncmp(rule, "check", 6);
	if (!obj->checker)
		obj->color = get_color_check(rule, data, line);
}
...
void	init_sphere(char **lines, t_data *data, int line)
{
	...
	init_check_board(new_obj, lines[3], data, line);
...
void	init_cylinder(char **lines, t_data *data, int line)
{
	...
	init_check_board(new_obj, lines[5], data, line);
