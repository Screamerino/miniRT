...
/*   Updated: 2022/03/25 19:09:52 by bstrong          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rotate_cam_x(t_cam *cam, float num);
void	rotate_cam_y(t_cam *cam, float num);
void	rotate_cam_z(t_cam *cam, float num);
